...
<!-- trending articles -->
<!-- add categories -->
<!-- in every category there are admins -->
...
<div class="container-fluid row">
	...
	<div class="col-3  pr-1 pl-1">
		...
		<div>
			...
			Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius mollitia nemo nobis saepe tempore quisquam cupiditate dolorem tempora a officiis. Delectus optio dolorum in, facilis cumque amet placeat vel mollitia!
		</div>
		<br>
	...
	<div class="col-6  pr-1 pl-1">
		...
		<div>
			...
			Et quaerat doloribus a molestiae cum ut, expedita unde quia. Esse libero optio minus nulla, nihil repellat totam cupiditate officiis? Consequatur iusto reprehenderit ullam laudantium laborum, aut exercitationem voluptate facilis?
			Labore officia repudiandae voluptates obcaecati, libero doloremque nobis molestias id commodi nisi non dignissimos in expedita veritatis reprehenderit aspernatur fugit quisquam distinctio sed velit ducimus. Iusto temporibus ea omnis esse!
		</div>
		<br>
		<button type="submit" class="btn btn-info">EDIT ARTICLE</button>
