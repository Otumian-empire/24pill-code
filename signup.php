	...
	<div class="card card-register mx-auto mt-0">
		...
		<div class="card-body">
			...
			<form method="POST" action="controllers/signup_processor.php" class="">
					...
					<div class="form-row">
						...
						<div class="col-md-6">
							...
							<div class="form-label-group">
								<input type="text" class="form-control" id="first_name" name="sign_up_first_name" placeholder="First name" value="<?php if (isset($_GET['first_name'])) { echo urldecode($_GET['first_name']); } ?>" autofocus/>
						...
						<div class="col-md-6">
							<!-- last name -->
							<div class="form-label-group">
								<input type="text" class="form-control" id="last_name" name="sign_up_last_name" placeholder="Last name" value="<?php if (isset($_GET['last_name'])) { echo urldecode($_GET['last_name']); } ?>" />
				...
				<div class="form-group">
					<div class="form-label-group">
						<input type="email" class="form-control" id="email" name="sign_up_email" placeholder="Name@example.com" value="<?php if (isset($_GET['sign_up_email'])) { echo urldecode($_GET['sign_up_email']); } ?>" />
				...
				<div class="form-group">
					...
					<div class="form-label-group">
						...
						<textarea class="form-control" id="user_bio" name="sign_up_user_bio" rows="3" placeholder="About me"><?php if (isset($_GET['user_bio'])) { echo urldecode($_GET['user_bio']); } ?></textarea>
