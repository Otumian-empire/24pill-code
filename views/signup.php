...
<div class="form-group">
	...
	<textarea class="form-control-md" id="user_bio" name="user_bio" rows="3" placeholder="About me"></textarea>
</div>

<!-- button -->
<button type="submit" class="btn btn-primary mb-2" name="register_button">REGISTER</button>
</form>
<!-- form ends here -->
</div>
